package com.ferius_057.onlineToStatus.vkApi;

import com.ferius_057.onlineToStatus.Config;
import com.ferius_057.onlineToStatus.Request;
...
public class Status {
    public boolean setStatus(String text) {
        try {
            String request = new Request().get("https://api.vk.com/method/status.set?text=" + URLEncoder.encode(text, "UTF-8") + "&group_id=" + Config.group_id + "&access_token=" + Config.user_token + "&v=5.130");
